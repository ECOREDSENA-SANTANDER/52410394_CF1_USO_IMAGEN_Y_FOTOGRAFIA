  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderF.fle-circulo(columnas="col-lg-6" data-aos="fade-down")
      ...
      .tarjeta.bg2.p-4.px-lg-5.text-center
        ...
        .bg-color-acento-contenido.w-fit.m-auto.py-1.px-5.mb-3
          h4.mb-0 Naranja
        p Puede relacionarse con cosas como regocijo, fiesta, placer, aurora, atardecer; logra algunos de los efectos del rojo, pero en menor grado, es un color incandescente, ardiente y brillante, estimula el esparcimiento, la vitalidad, la diversión, el movimiento y disminuye la fatiga estimulando el sistema respiratorio.
        p La visión del color naranja produce una sensación de mayor aporte de oxígeno al cerebro, logrando un efecto estimulante para la actividad mental, otra característica es que anima a seguir intentando luchar por una meta aun cuando ha ocurrido un problema en el proceso. Gracias a ese efecto estimulante se suele utilizar en los lugares de comida rápida ya que abre el apetito.
      .tarjeta.bg2.p-4.px-lg-5.text-center
        .color.color--amarillo.mb-4
        .bg-color-acento-contenido.w-fit.m-auto.py-1.px-5.mb-3
          h4.mb-0 Amarillo
      ...
      .tarjeta.bg2.p-4.px-lg-5.text-center
        ...
        .bg-color-acento-contenido.w-fit.m-auto.py-1.px-5.mb-3
          h4.mb-0 Negro
        p Por tradición es un color relacionado con la oscuridad y el dolor, la formalidad y solemnidad. Es la ausencia del color o de cualquier tipo de luz. Este color encierra un halo de tristeza.
        p El negro también se utiliza como símbolo de poder, elegancia y estilo. Las personas se sienten más delgadas cuando visten de negro. Se utiliza mucho en museos y galerías, gracias a su particularidad de resaltar los demás colores. Contrasta muy bien con colores brillantes.
